      ...
      {tabs.map((tab) => {
        ...
        return (
          <div
            ...
            className={`relative cursor-pointer px-3 py-2 rounded flex flex-col items-center transition-all duration-200 ease-in-out ${
          ...
          >
            ...
            {tab.icon === "notifications" &&
              ...
              notification.length > 0 && (
                <div className="absolute top-0 right-2 font-bold bg-red-600 w-4 h-4 rounded-full flex justify-center items-center text-white text-xs">
                  {notification.length}
                </div>
              )}
